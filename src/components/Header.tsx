          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              <img 
                ...
                alt="Transferko Logo" 
                className="h-10 w-auto object-contain max-w-[140px] sm:h-12 sm:max-w-[160px] md:h-14 md:max-w-[180px] lg:h-16 lg:max-w-[200px]"
              />
            </button>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button
                ...
                className="lg:hidden p-2 rounded-xl text-slate-800 hover:bg-lime-300 flex-shrink-0"
              >
